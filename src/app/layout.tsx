...
export const metadata: Metadata = {
  title: "Sage by VirtuaLab Digital — Organic Website Builder for Makers",
  description:
  ...
  authors: [{ name: "Sage by VirtuaLab Digital" }],
  icons: {
    icon: "https://z-cdn.chatglm.cn/z-ai/static/logo.svg",
  },
  openGraph: {
    title: "Sage by VirtuaLab Digital — Organic Website Builder",
